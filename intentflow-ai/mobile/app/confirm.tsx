...
const styles = StyleSheet.create({
  ...
  heroBadge: { width: 64, height: 64, borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginBottom: 20, shadowColor: '#6C63FF', shadowOpacity: 0.4, shadowRadius: 15, elevation: 12 },
  ...
  confirmBtn: { borderRadius: 16, overflow: 'hidden', shadowColor: '#6C63FF', shadowOpacity: 0.4, shadowRadius: 16, elevation: 8 },
